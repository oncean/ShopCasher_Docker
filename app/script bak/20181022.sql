...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`shopcasher` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `t_shop`(`shopId`,`createTime`,`createUserId`,`location`,`shopName`,`shop_id`,`create_time`,`create_user_id`,`owner_user_id`,`shop_name`,`status`) values ('iqIZriuyEry2367Z7bJnUBfa','2018-06-04 23:19:22','iuYNzyMRn6FvYzYFjufuYzYf','2123','dianpi2','',NULL,NULL,NULL,NULL,NULL),('NJbUb2e6NJJ3BZVrMjyaiIfa','2018-06-08 23:24:47','fUZNzy3Ir6vqrQn6RnJJvYfa','莱娅媛','君乐超市','',NULL,NULL,NULL,NULL,NULL),('NnYbi2UF7zmumQnARrZzIJBb','2018-05-14 15:08:13','iuYNzyMRn6FvYzYFjufuYzYf','加油站','君乐超市','',NULL,NULL,NULL,NULL,NULL),('Z3MraiRnQf6zei6bUb22IvIn','2018-06-04 23:36:56','iuYNzyMRn6FvYzYFjufuYzYf','weqwe','q\'e\'q\'we','',NULL,NULL,NULL,NULL,NULL);
